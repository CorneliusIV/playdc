...
export const EXTRAS_GLOB = './playlistdc/static_src/**/*.{txt,json,xml,ico,jpeg,jpg,png,gif,svg,ttf,otf,eot,woff,woff2}'

let bundler = browserify(['./playlistdc/static_src/js/app.js'], { debug: true })
...
gulp.task('clean', () => del('./playlistdc/static/'))
...
gulp.task('sass', () =>
  gulp.src('./playlistdc/static_src/scss/**/*.scss')
    .pipe(plumber())
    .pipe(stylelint({
      syntax: 'scss',
      reporters: [{
